#property strict
#property description "TrendRecoveryEA v1.28 - Recovery Exit Engine Upgrade"

// Keep the proven v1.27 core intact.
// Rename its event/management functions so this wrapper can provide the v1.28
// recovery engine without touching the entry/reversal logic.
#define RecoveryEngine RecoveryEngine_v127
#define ManagePositions ManagePositions_v127
#define OnTick OnTick_v127
#include "TrendRecoveryEA.mq5"
...
void RecoveryEngine()
{
   ...
   // v1.28: do not close merely because recovery made its target while the
   // original leg is still losing. The whole campaign must reach the minimum.
   ...
   // v1.28: let profitable recovery positions breathe and protect real profit.
