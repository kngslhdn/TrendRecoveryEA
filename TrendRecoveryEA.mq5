...
#property description "TrendRecoveryEA v1.34 - hard USD loss protection and cycle-based equity profit protection."
...
string GVProfitPeak(){return "TRENDREC_PROFITPEAK_V134_"+(string)MagicNumber+"_"+_Symbol;}
string GVProfitStart(){return "TRENDREC_PROFITSTART_V134_"+(string)MagicNumber+"_"+_Symbol;}
